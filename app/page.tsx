...
const CONFIG = {
  "backend_url": "https://8g1uuaplu3.execute-api.ap-south-1.amazonaws.com/dev/inference"
}
    ...
    <div className="flex min-h-screen flex-col items-center justify-center py-2">
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <div className="mt-10 text-lg">
          Select an Image from <a href="https://www.kaggle.com/datasets/puneet6060/intel-image-classification" target="_blank" className='text-blue-600'>Example</a>
        </div>
        <div className='mt-10 flex flex-row space-x-5 text-xl'>
          <div>
            <input className="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" accept='image' onChange={(e) => {
